...
- (NSURL *) requestURLForLocation:(CLLocation *)location {
    NSString * baseURL = [NSString stringWithFormat:@"https://maps.googleapis.com/maps/api/place/search/json?radius=1000&sensor=true&key=%@", key];
...
- (NSURL *) requestURLForDetails:(Quest *) quest {
    NSString * baseURL = [NSString stringWithFormat:@"https://maps.googleapis.com/maps/api/place/details/json?key=%@&sensor=true&reference=%@", key, quest.reference];
